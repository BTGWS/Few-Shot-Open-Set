...
sys.path.append('/home/snag005/Desktop/fs_ood/trial2/')
...
tr_loader = data_loader(phase='train',do_not_use_random_transf=True)
val_loader = data_loader(phase='val')
te_loader = data_loader(phase='test')
...
trainloader = DataLoader(tr_loader, batch_size=100, num_workers=4, shuffle=False, collate_fn=tr_loader.collate_fn ,sampler=sampler_tr)
valloader = DataLoader(val_loader, batch_size=100, num_workers=4, shuffle=False, collate_fn=val_loader.collate_fn ,sampler=sampler_val)
testloader = DataLoader(te_loader, batch_size=100, num_workers=4, shuffle=False, collate_fn=te_loader.collate_fn ,sampler=sampler_test)
...
root = '/home/snag005/Desktop/fs_ood/trial2/datasets/db/miniimagenet2/'
