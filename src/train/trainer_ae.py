...
# from train.tester_ae import tester
    ...
    for epoch in range(1,max_epoch+1):
        ...
        for i,episode in enumerate(train_loader):
            ...
            for k in classes:
                 ...
                 _,emb_support,_,recon,_ = model(Dx_k)              
            ...
            for k in classes:     
                 ...
                 # novelty detection
                 ND_input = torch.cat((pred,diff_metric,emb_query),dim=1) # Nq x dim+2C emb_enhance(emb_query,all_sym_protos)
